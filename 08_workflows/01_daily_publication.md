...
### Шаг 5: Показ черновика (1 минута)

1. Покажи готовый пост пользователю
2. Спроси: **«Опубликовать этот пост в Telegram?»**
3. Дождись подтверждения

### Шаг 6: Публикация (1 минута)

**Вариант A: Ручная публикация (рекомендуется)**

1. Пользователь копирует пост
2. Публикует в Telegram вручную
3. Сообщает AI об успешной публикации

**Вариант B: Через бота (если настроен)**

1. AI отправляет пост через Telegram-бота
2. Получает ID сообщения
3. Передаёт ID пользователю

### Шаг 7: Запись в историю (1 минута)
...
- [ ] Получено подтверждение на публикацию
- [ ] Пост опубликован
