...
### [2026-04-14] Huawei выпустила Ascend 950PR: AI-чип в 2.8 раза быстрее NVIDIA H20

- **Category:** hardware
- **Template:** telegra.ph article
- **Key topics:** hardware, huawei, nvidia, ai_chips, china_tech
- **Sources:**
  - NerdLevelTech (https://nerdleveltech.com/huawei-ascend-950pr-atlas-350-ai-chip-challenges-nvidia)
  - Tech-Insider (https://tech-insider.org/huawei-ascend-950pr-ai-chip-nvidia-china-2026/)
  - HuaweiCentral (https://www.huaweicentral.com/huawei-ascend-950pr-wins-over-nvidia-ai-chips-in-performance/)
  - DigiTimes (https://www.digitimes.com/news/a20260324PD210/huawei-ascend-performance-2026.html)
- **Telegra.ph URL:** https://telegra.ph/Huawei-vypustila-Ascend-950PR-AI-chip-v-28-raza-bystree-NVIDIA-H20-04-14
- **Telegram ID:** 487
- **Status:** published

<!-- CONTENT_START -->
Huawei официально представила **Ascend 950PR** — новый AI-процессор, который позиционируется как полноценная альтернатива чипам NVIDIA для китайского рынка. Устройство демонстрирует производительность, превышающую NVIDIA H20 в **2.8 раза** в задачах инференса больших языковых моделей.

## Технические характеристики

Ascend 950PR построен на базе монолитного кристалла, произведённого по техпроцессу **SMIC 7nm (N+2)**. Такой подход снижает зависимость от сложной CoWoS-упаковки TSMC, к которой применяются экспортные ограничения.

Ключевые параметры:

- **Производительность** — 1.56 PFLOPS (FP4), 1 PFLOPS (FP8)
- **Память** — 112 ГБ собственной HBM HiBL 1.0 с пропускной способностью 1.4 ТБ/с
- **Интерконнект** — протокол LingQu с пропускной способностью 2.0 ТБ/с между чипами
- **Энергопотребление** — 600 Вт
- **Шаг доступа к памяти** — сокращён до 128 байт (в 4 раза эффективнее для мелких операторов)

## CANN Next: совместимость с CUDA

Главный прорыв — программный стек **CANN Next**, который реализует SIMT-модель программирования, зеркально повторяющую абстракции CUDA (thread blocks, warps, kernel launches). Это обеспечивает:

- **~80% совместимости** со стандартным PyTorch-инференсом без переписывания кода
- Прямую замену CUDA-интерфейсам без накладных расходов на трансляцию
- Сокращение времени миграции с месяцев до недель

Кастомные CUDA-ядра и задачи обучения всё ещё требуют доработок, но для типового инференса барьер миграции практически устранён.

## Atlas 350 и масштабирование

Чип поставляется в составе ускорителя **Atlas 350** в двух конфигурациях:

- **Премиальная** — с HBM HiBL 1.0 (~$9 600) для задач, требовательных к пропускной способности
- **Бюджетная** — с DDR-памятью (~$6 900) для экономичных развёртываний

Huawei также анонсировала систему **Atlas 950 SuperCluster**, способную объединять до **1 млн NPU** через шину UnifiedBus 2.0. По заявленным характеристикам, она превосходит NVIDIA NVL144 в 6.7 раз по вычислительной мощности и в 15 раз по объёму памяти (1152 ТБ).

## Клиенты и объёмы

Крупнейшие китайские технологические компании уже подтвердили заказы:

- **ByteDance** — контракт на $5.6 млрд для поддержки инференса более чем для 1.5 млрд пользователей
- **Alibaba Cloud и Tencent** — значительные заказы, общий спрос оценивается в $12–15 млрд на 2026 год
- **Baidu** — интеграция 950PR в дата-центры Kunlun к Q3 2026 для моделей Ernie AI

План поставок на 2026 год — **750 000 единиц**, массовое производство стартует во втором квартале.

## Влияние на рынок

Huawei прогнозирует захват **35–40% китайского рынка AI-чипов** к 2027 году, впервые обойдя NVIDIA по выручке в регионе. Ожидается, что выручка NVIDIA в Китае снизится до $8–10 млрд (против $12–14 млрд в 2026 году).

Проект ускоряет «деамериканизацию» AI-инфраструктуры Китая и может привлечь страны Ближнего Востока и Юго-Восточной Азии, сталкивающиеся с ограничениями на лицензирование NVIDIA.

## Ограничения

Несмотря на впечатляющие характеристики, у Ascend 950PR есть слабые стороны:

- **Пропускная способность памяти** (1.4 ТБ/с) уступает NVIDIA H20 (4.0 ТБ/с) в 3 раза, что снижает эффективность для long-context LLM
- **Энергопотребление** на 50% выше (600 Вт против 400 Вт) из-за более грубого техпроцесса
- **Выход годных кристаллов** — 50–60%, что создаёт риски для массового производства

## Что дальше

Huawei уже работает над следующим поколением: **Ascend 970 (2028 год)** нацелен на достижение паритета или превосходства над архитектурой NVIDIA Rubin+. Раскол глобального рынка на две экосистемы (NVIDIA/CUDA и Huawei/CANN) может усложнить кросс-платформенную разработку моделей в ближайшие годы.

---

Источники:

- [NerdLevelTech — Huawei Ascend 950PR: The AI Chip Challenging NVIDIA](https://nerdleveltech.com/huawei-ascend-950pr-atlas-350-ai-chip-challenges-nvidia)
- [Tech-Insider — Huawei Ascend 950PR: The 1.56 PFLOP AI Chip vs Nvidia](https://tech-insider.org/huawei-ascend-950pr-ai-chip-nvidia-china-2026/)
- [HuaweiCentral — Ascend 950PR wins over Nvidia AI chips](https://www.huaweicentral.com/huawei-ascend-950pr-wins-over-nvidia-ai-chips-in-performance/)
- [DigiTimes — Huawei Ascend 950PR debuts](https://www.digitimes.com/news/a20260324PD210/huawei-ascend-performance-2026.html)
<!-- CONTENT_END -->
